#
#  Be sure to run `pod spec lint RXGetAddressBook.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "sunmengxin"
  # s.authors            = { "sunmengxin" => "sunmengxin@126.cn" }
  # s.social_media_url   = "https://github.com/srxboys/"
